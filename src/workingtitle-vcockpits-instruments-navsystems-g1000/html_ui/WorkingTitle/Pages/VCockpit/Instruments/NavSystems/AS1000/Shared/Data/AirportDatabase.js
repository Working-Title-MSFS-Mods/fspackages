class WT_Airport_Database_Timezone {
    constructor(data) {
        this.e = data.split(",").map(data => {
            return data.split(":");
        });
    }
    getActiveEntry() {
    ...
    get unix() {
        return this.getActiveEntry()[0];
    }
    get timezone() {
        return this.getActiveEntry()[1];
    }
    get offset() {
        return this.getActiveEntry()[2];
    }
}

class WT_Airport_Database_Airport {
