class WT_Metar_Entry {
    constructor(ident, metar) {
        this.ident = ident;
        this.metar = metar;
    }
    getMetar() {
...
class WT_Metar_Downloader {
    constructor(url = null) {
        this.url = url || "https://api.codetabs.com/v1/proxy/?quest=https://fsxweatherstorage.blob.core.windows.net/fsxweather/metars.bin";
    }
    download() {
