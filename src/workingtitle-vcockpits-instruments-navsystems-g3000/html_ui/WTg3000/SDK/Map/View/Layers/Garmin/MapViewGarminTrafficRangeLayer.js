 ...
 */
class WT_MapViewGarminTrafficRangeLayer extends WT_MapViewLabeledRingLayer {
    constructor(className = WT_MapViewGarminTrafficRangeLayer.CLASS_DEFAULT, configName = WT_MapViewGarminTrafficRangeLayer.CONFIG_NAME_DEFAULT) {
        super(className, configName);

        this._outerRing = new WT_MapViewLabeledRing(new WT_MapViewRing(), new WT_MapViewGarminTrafficRangeLabel(false));
        this._innerRing = new WT_MapViewLabeledRing(new WT_MapViewRing(), new WT_MapViewGarminTrafficRangeLabel(true));
        ...
        this._optsManager = new WT_OptionsManager(this, WT_MapViewGarminTrafficRangeLayer.OPTIONS_DEF);
    ...
    onConfigLoaded(state) {
        for (let property of WT_MapViewGarminTrafficRangeLayer.CONFIG_PROPERTIES) {
...
WT_MapViewGarminTrafficRangeLayer.CLASS_DEFAULT = "trafficRangeLayer";
WT_MapViewGarminTrafficRangeLayer.CONFIG_NAME_DEFAULT = "trafficRange";
WT_MapViewGarminTrafficRangeLayer.OPTIONS_DEF = {
...
WT_MapViewGarminTrafficRangeLayer.CONFIG_PROPERTIES = [
    "outerStrokeWidth",
    "outerStrokeColor",
    "outerStrokeDash",
    "outerOutlineWidth",
...
class WT_MapViewGarminTrafficRangeLabel extends WT_MapViewRingLabel {
    constructor(isInner) {
        super();
