...
class WT_MapAltitudeInterceptSetting extends WT_MapSetting {
     ...
     */
    constructor(model, isSyncable = true, isPersistent = true, key = WT_MapAltitudeInterceptSetting.SHOW_KEY_DEFAULT) {
        super(model, key, false, isSyncable, true, isPersistent);
    }
