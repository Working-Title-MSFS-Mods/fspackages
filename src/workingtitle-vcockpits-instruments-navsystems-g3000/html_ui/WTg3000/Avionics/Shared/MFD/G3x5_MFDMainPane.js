class WT_G3x5_MFDMainPane extends NavSystemElement {
    ...
    _initHalfPanes() {
        this._left = new WT_G3x5_MFDHalfPane(this.htmlElement.querySelector(`mfd-halfpane[slot="left"]`), this.instrumentID, WT_G3x5_MFDHalfPane.ID.LEFT, this._icaoWaypointFactory, this._icaoSearchers, this._flightPlanManager, this._unitsController, this._citySearcher, this._borderData, this._roadFeatureData, this._roadLabelData);
        this._right = new WT_G3x5_MFDHalfPane(this.htmlElement.querySelector(`mfd-halfpane[slot="right"]`), this.instrumentID, WT_G3x5_MFDHalfPane.ID.RIGHT, this._icaoWaypointFactory, this._icaoSearchers, this._flightPlanManager, this._unitsController, this._citySearcher, this._borderData, this._roadFeatureData, this._roadLabelData);
    }
...
class WT_G3x5_MFDHalfPane {
    constructor(htmlElement, instrumentID, halfPaneID, icaoWaypointFactory, icaoSearchers, flightPlanManager, unitsController, citySearcher, borderData, roadFeatureData, roadLabelData) {
        ...
        this._navMap = new WT_G3x5_NavMap(id, icaoWaypointFactory, icaoSearchers, flightPlanManager, unitsController, citySearcher, borderData, roadFeatureData, roadLabelData);
