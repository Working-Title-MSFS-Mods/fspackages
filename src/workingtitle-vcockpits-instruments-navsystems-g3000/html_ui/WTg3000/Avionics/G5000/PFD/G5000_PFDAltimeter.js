...
class WT_G5000_PFDAltimeterAltitudeHTMLElement extends WT_G3x5_PFDAltimeterAltitudeHTMLElement {
    ...
    _initMetersFormatter() {
        ...
        this._metersFormatter = new WT_NumberHTMLFormatter(formatter, {
            classGetter: {
                ...
                getUnitClassList: (numberUnit, forceUnit) => [WT_G5000_PFDAltimeterAltitudeHTMLElement.UNIT_CLASS]
            },
            numberUnitDelim: ""
        });
    }
    ...
    _setAlertState(state) {
        this._wrapper.setAttribute("alert", WT_G5000_PFDAltimeterAltitudeHTMLElement.ALTITUDE_ALERT_STATE_ATTRIBUTE[state]);
    }
}
WT_G5000_PFDAltimeterAltitudeHTMLElement.ALTITUDE_ALERT_STATE_ATTRIBUTE = [
    "none",
    "1000",
    "200",
    "captured",
