    ...
    _initPages() {
        ...
        this.pageGroups = [
            ...
            new NavSystemPageGroup("MFD", this, [
                ...
                new NavSystemPage("Departure Selection WT", "DepartureSelectionWT", new WT_G3x5_TSCDepartureSelection("MFD", "MFD Home", this.instrumentIdentifier)),
                new NavSystemPage("Arrival Selection WT", "ArrivalSelectionWT", new WT_G3x5_TSCArrivalSelection("MFD", "MFD Home", this.instrumentIdentifier)),
                new NavSystemPage("Approach Selection WT", "ApproachSelectionWT", new WT_G3x5_TSCApproachSelection("MFD", "MFD Home", this.instrumentIdentifier)),
