class Jet_PFD_AirspeedIndicator extends HTMLElement {
    ...
    construct_CJ4() {
        ...
        }
        {
            ...
            this.machPrefixSVG.setAttribute("x", (posX - 23).toString());
        ...
        this.centerSVG.setAttribute("viewBox", "0 0 " + width + " " + height);
        {
            ...
            this.createSpeedMarker("AP", speedMarkersPosX, speedMarkersPosY, this.updateMarkerVApp, 0.8, 1.2, "cyan", false, [], 15, 0);
