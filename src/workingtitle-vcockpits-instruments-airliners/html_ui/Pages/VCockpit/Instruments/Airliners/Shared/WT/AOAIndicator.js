class Jet_PFD_AOAIndicator extends HTMLElement {
    ...
    construct_CJ4() {
        ...
        posY -= centerHeight;
        {
            ...
            text.setAttribute("y", (_top + 30).toString());
            text.setAttribute("fill", "#a1a1a1");
            text.setAttribute("font-size", (this.fontSize + 3).toString());
            ...
            graduationVLine.setAttribute("stroke", "#a1a1a1");
        ...
        borderline.setAttribute("y1", "55");
        borderline.setAttribute("x2", blx);
        borderline.setAttribute("y2", "435");
