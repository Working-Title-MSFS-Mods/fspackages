class CJ4_FMC_InitRefIndexPage {
    ...
    static async ShowPage10(fmc, currentPage = 1) { //FREQUENCY
        ...
        fmc.onLeftInput[5] = () => { CJ4_FMC_InitRefIndexPage.ShowPage1(fmc); };
        fmc.onPrevPage = () => { CJ4_FMC_InitRefIndexPage.ShowPage10(fmc, currentPage === 1 ? pageCount : (currentPage - 1)); };
        fmc.onNextPage = () => { CJ4_FMC_InitRefIndexPage.ShowPage10(fmc, currentPage === pageCount ? 1 : (currentPage + 1)); };
        fmc.updateSideButtonActiveStatus();
    }
