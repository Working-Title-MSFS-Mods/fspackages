    ...
    static ShowPage2(fmc) { //FUEL MGMT Page 2
        ...
        fmc.registerPeriodicPageRefresh(() => {
            ...
            fmc._templateRenderer.setTemplateRaw([
                ...
                ["   1[d-text]", fuelBurnedLeftDisplay.toString().padStart(4, " ") + " [d-text]", Math.round(SimVar.GetSimVarValue("L:CJ4 FUEL FLOW:1", "Pounds per hour")).toString().padStart(4, " ") + "[d-text]"],
                ["   2[d-text]", fuelBurnedRightDisplay.toString().padStart(4, " ") + " [d-text]", Math.round(SimVar.GetSimVarValue("L:CJ4 FUEL FLOW:2", "Pounds per hour")).toString().padStart(4, " ") + "[d-text]"],
