        ...
        if (flightDirector || apMasterActive) {
            ...
            if (fmaValues) {
                ...
                if (verticalMode == "VS" || verticalMode == "VVS") {
                    ...
                    const pitchRef = pitchRef > 0 ? Math.min(SimVar.GetSimVarValue("AUTOPILOT PITCH HOLD REF", "degrees"), 10) : Math.max(SimVar.GetSimVarValue("AUTOPILOT PITCH HOLD REF", "degrees"), -10);
                    this.AP_VerticalActive.setDisplayValue(verticalMode);
                    this.AP_ModeReference_Icon.style.display = "none";
